...
from .models import *
import json
import datetime # <--- QUAN TRỌNG: Để xử lý ngày giờ khi thanh toán
from django.core.paginator import Paginator # <--- QUAN TRỌNG: Để phân trang sản phẩm
...
def home(request):
    ...
    try:
        ...
        # Fallback cho phiên bản Django cũ hơn nếu không có elided_page_range
...
def search(request):
    searched = ""
    keys = [] # Khởi tạo danh sách rỗng để tránh lỗi
